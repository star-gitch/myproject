  ...
  return (
    <div>
      <Helmet>
        ...
        <meta
          name="description"
          content="Sona Mandhira (formerly known as Mandira Marketing.) have been passionately serving the aftermarket by creating an unmatched value for customers. The wide range of world-class products has made SMPL one of the leading car spares manufacturers. The products are sold under distinct brands for different vehicle segments."
        />
      </Helmet>
