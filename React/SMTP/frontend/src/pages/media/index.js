  ...
  return (
    <div>
      <Helmet>
        <meta
          name="description"
          content="Sona Mandhira owing to its fast expanding range and geographies has been featured in leading media houses and also won several accolades.  "
        />
        <title>Sona Mandhira Pvt Ltd in Media </title>
