  ...
  return (
    <div>
      <Helmet>
        ...
        <meta
          name="description"
          content="SMPL’s products are distributed in the Indian market through dedicated distribution networks focusing on supply of Shock absorbers, Steering System, Suspensions, Brake Parts, Car filters, Wiper blades, Dickey and Bonnet shockers etc. The philosophy is to offer the best value products with wide range of application."
        />
      </Helmet>
